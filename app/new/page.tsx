  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">New Agent</h1>
          <p className="text-gray-600 mt-1">Create a personal agent definition.</p>
        </div>
      ...
      <form onSubmit={onSubmit} className="bg-white border border-gray-200 rounded-lg p-6 space-y-4">
        <div>
          ...
          />
          <p className="text-xs text-gray-500 mt-1">Unique identifier (kebab-case recommended).</p>
        </div>
