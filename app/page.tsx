    ...
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <div className="text-sm text-gray-600">Personal active agents</div>
          <div className="text-2xl font-semibold text-gray-900">
            {stats.personalActive}
            <span className="text-sm text-gray-500 font-normal"> / {stats.personalTotal}</span>
          </div>
        </div>
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <div className="text-sm text-gray-600">Built-in active agents</div>
          <div className="text-2xl font-semibold text-gray-900">
            {stats.builtinActive}
            <span className="text-sm text-gray-500 font-normal"> / {stats.builtinTotal}</span>
          </div>
        </div>
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <div className="text-sm text-gray-600">Total active agents</div>
          <div className="text-2xl font-semibold text-gray-900">
            {stats.totalActive}
